...
public interface TaskRepositoryCustom {
    ...
    /**
     * Find task by group per week list.
     *
     ...
     * @return the list
     */
    List<TaskData> findTaskByGroupPerWeek(List<Long> groupIds, List<Integer> years, List<Integer> weeks);
    ...
    /**
     * Find effort by week of actual capacity list.
     *
     * @param years the years
     * @param weeks the weeks
     * @return the list
     */
    List<TaskData> findEffortByWeekOfActualCapacity(List<Integer> years, List<Integer> weeks);
}
